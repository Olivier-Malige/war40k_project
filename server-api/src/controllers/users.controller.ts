import { createUser, findUserPerUsername, searchUsersPerUsername } from '../queries/users.queries';
...
export const userProfile = async (req: Request, _res: Response, next: NextFunction) => {
  try {
